      ...
      <div className='p-3'>
        <List spacing={1}>
          ...
          <ListItem className=' cursor-pointer flex flex-row hover:bg-slate-300 p-2 rounded-r-[40px]'>
            ...
            <h1 className=' text-lg font-medium'>For Sci</h1>
          </ListItem>

          <ListItem className=' cursor-pointer flex flex-row hover:bg-slate-300 p-2 rounded-r-[40px]'>
            <BsPersonCircle size={20} className='my-auto mr-5' />
            <h1 className=' text-lg font-medium'>Computer Literacy-COM101GO</h1>
          </ListItem>

          <ListItem className=' cursor-pointer flex flex-row hover:bg-slate-300 p-2 rounded-r-[40px]'>
            <BsPersonCircle size={20} className='my-auto mr-5' />
            <h1 className=' text-lg font-medium'>Level 1 science 2022</h1>
          </ListItem>
